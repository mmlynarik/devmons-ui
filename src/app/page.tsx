...
export default function Home() {
  return (
    <div className="grid max-h-screen grid-rows-[20px_1fr_20px] items-center justify-items-center gap-15 font-[family-name:var(--font-geist-sans)] sm:p-30">
      ...
      <footer className="row-start-3 flex justify-center gap-3">
